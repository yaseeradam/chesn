...
const createIcon = (paths: ReactNode, viewBox = "0 0 24 24", strokeWidth = 1.5) => {
    const IconComponent = ({ className = "w-6 h-6" }: IconProps) => (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox={viewBox} strokeWidth={strokeWidth} stroke="currentColor" className={className}>
            {paths}
        </svg>
    );
...
export const SyringeIcon = createIcon(
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3v2.25m4.5-2.25v2.25M9.75 21v-2.25m4.5 2.25v-2.25M3 9.75h2.25M3 14.25h2.25m15.75-4.5h-2.25m2.25 4.5h-2.25M12 12a2.25 2.25 0 100-4.5 2.25 2.25 0 000 4.5zm0 0v6.75" />
);
...
export const EmergencyIcon = createIcon(
...
export const HandHeartIcon = createIcon(
